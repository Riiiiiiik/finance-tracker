...
export async function middleware(request: NextRequest) {
    ...
    // Configuração de CSP Estrita (Nonces) - DESATIVADO TEMPORARIAMENTE PARA RESTAURO
    ...
    */
    ...
    // requestHeaders.set('x-nonce', nonce); // Desativando nonce
    // requestHeaders.set('Content-Security-Policy', cspHeader); // Desativando CSP
    ...
    // response.headers.set('Content-Security-Policy', cspHeader); // Desativando CSP da resposta
